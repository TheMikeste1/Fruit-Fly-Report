...
\subsubsection{Model}
The ripeness of an apple is determined by an SVM classifier model based on the HSV values of the apple image because it has been shown to be capable of having a high accuracy at fruit ripeness detection. %TODO cite https://www.researchgate.net/publication/342058112_Fruit_Ripeness_Based_on_RGB_HSV_HSL_Lab_Color_Feature_Using_SVM
