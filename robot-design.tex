...
As such, in order to overcome these challenges we developed an intelligence hierarchy to only perform calculations as required (\autoref{fig:intelligence-hierarchy}), and offloaded these calculations to 
